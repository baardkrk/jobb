...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Sperre AS}{Telemark Teknologipark\\Merdeveien 1\\N-3676 Notodden}
\date{04.03.17}
...
%% {\tiny\color{red}Det kommer ikke så klart frem på sidene dems om de faktisk driver med deteksjon. Det står bare at produktene leveres med en kontrollenhet.}
